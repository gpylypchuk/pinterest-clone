...
import { doc, getDoc, getFirestore, DocumentData } from 'firebase/firestore' // Import DocumentData
...
function PinDetail({params}: any) {
    ...
    const [pinDetail,setPinDetail]=useState<DocumentData>([]); // Update type of pinDetail
    useEffect(()=>{
        getPinDetail();
    },[])
